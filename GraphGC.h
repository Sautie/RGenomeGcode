...
class GraphGC
{
    public:
        ...
        GraphGC(vector <double> &, vector <string> &, int, int, int, int, int, int, int);
        GraphGC(vector <double> &, vector <double> &, vector <string> &, int, int, int, int, int, int, int);
       ...
       vector<vector<vector<double> > > meGPart(int, int,vector< vector<double> >, vector< vector<double> >, vector<int>,vector<int>,vector<double>);
    ...
    private:
       ...
       // void setWU(int, int);
        void setWG(int i, int j, double w, double g);
